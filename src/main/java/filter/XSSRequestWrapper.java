...
public class XSSRequestWrapper extends HttpServletRequestWrapper {
    ...
    private String stripXSS(String value) {
        if (value != null) {
            ...
            value = scriptPattern.matcher(value).replaceAll(""); // Avoid anything in a src="..." type of e­xpression
            ...
            value = scriptPattern.matcher(value).replaceAll(""); // Avoid onload= e­xpressions
